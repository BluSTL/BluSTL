function controller = STLC_get_controller_interval(Sys)
% STLC_get_controller_interval constructs the controller object for an 
%                              STLC_lti instance using interval semantics
%                           
% Input: 
